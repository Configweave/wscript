...
pub fn default_help(code: &str) -> Option<&'static str> {
    Some(match code {
        ...
        "E0007" => "this character is not part of wisp's syntax",
        ...
        "E0103" => "supported attributes: #[derive(...)] (and #[opaque] in .wispi files)",
        ...
        "E0201" => "check the module's .wispi interface for its items",
        ...
        "E0227" => "wisp has no truthiness: write an explicit comparison",
        ...
        "E0270" => "this form belongs to .wispi interface files, not scripts",
